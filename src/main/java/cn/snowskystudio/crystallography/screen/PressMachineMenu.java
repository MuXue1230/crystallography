...
public class PressMachineMenu extends AbstractContainerMenu {
    ...
    public PressMachineMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 29, 35));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 54, 35));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 123, 35));
        });
